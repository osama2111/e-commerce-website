...
export const Banner = () => {
    return (
        <div className='py-8 flex justify-center items-center min-h-[500px] px-4 lg:px-8 xl:px-12 '>
            <div className='bg-brandGreen rounded-3xl px-4 lg:px-8 xl:px-12 space-y-6 '>
                {Bannerdata.map((banner) => (
                    <div key={banner.id} className=' grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-12 items-center '>
                        ...
                        <div data-aos="zoom-out" data-aos-duration="500" data-aos-delay="100" data-aos-once="false" className='flex flex-col items-start justify-center gap-4 text-white'>
